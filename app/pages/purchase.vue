        ...
        <div>
          ...
          <p>
            <input
              type="text"
              placeholder="性"
              v-model="userInfo.shimei"
              require
            /><input
              type="text"
              placeholder="名"
              v-model="userInfo.miyoji"
              require
            />
          </p>
          電話番号 必須
          ...
          <p v-if="todoData">
            選択された都道府県名: {{ todoData[userInfo.selectedPlace] || "" }}
          </p>
          番地 必須
...
console.log(`purchase_testPs:${props.testPs}`);
console.log(`purchase_indexToPurchase:${props.indexToPurchase}`);
</script>